...
public class Perpustakaan {
  public static void main(String[] args) {
    ...
    dataMahasiswa.add(new Mahasiswa("0", "Helfi Apriliyandi Firdaos"));
    dataMahasiswa.add(new Mahasiswa("1", "Daffa Akhdan"));
    dataMahasiswa.add(new Mahasiswa("2", "Dini Aryani"));

    ArrayList <Buku> dataBuku = new ArrayList<>(); 

    dataBuku.add(new Buku("0", "C++"));
    dataBuku.add(new Buku("1", "HTML"));
    dataBuku.add(new Buku("2", "CSS"));
  ...
  public static void menuMahasiswa(ArrayList <Mahasiswa> dataMahasiswa) {
    ...
    while(keluar != 1) {
      ...
      switch(menu) {
        ...
        case 3:
          System.out.print("Masukan No untuk dihapus : ");
